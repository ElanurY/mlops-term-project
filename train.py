...
# Fraud olan ve olmayan işlemleri ayır, oversample ile dengele
...
print("Dataset oluşturuldu (balanced):", df_balanced.shape)
print("Fraud oranı:", df_balanced['fraud'].mean())
...
# --- Deney 3: Random Forest (fazla ağaç) ---
